...
builder.Services.AddScoped<IRepository<ProductCategoryData>, ProductContextRepository<ProductCategoryData>>();
builder.Services.AddScoped<IRepository<FlavorData>, ProductContextRepository<FlavorData>>();
builder.Services.AddScoped<IRepository<ProductTagData>, ProductContextRepository<ProductTagData>>();
builder.Services.AddScoped<IRepository<CountryData>, ProductContextRepository<CountryData>>();
builder.Services.AddScoped<IRepository<ProductImageData>, ProductContextRepository<ProductImageData>>();
